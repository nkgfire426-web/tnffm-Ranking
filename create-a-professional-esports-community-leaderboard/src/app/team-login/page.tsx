    ...
    <main className="min-h-screen bg-[#050507] px-4 py-16 text-white">
      <div className="mx-auto max-w-md">
        ...
        <form onSubmit={submit} className="glass space-y-5 rounded-2xl p-6">
          ...
          <button
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-gold px-4 py-3 font-bold text-black disabled:opacity-50"
          >
            {register ? <UserPlus className="h-4 w-4" /> : <LogIn className="h-4 w-4" />}
            {loading ? "Please wait..." : register ? "Create Team Account" : "Login"}
          </button>
