...
export function normalizeImageUrl(src?: string | null) {
  ...
  // Google Drive / Drive User Content links are routed through the same
  // controlled image proxy used by the site. This also handles sharing links
  // containing resourcekey=..., which Google may require for newer files.
  if (/drive\.google\.com|drive\.usercontent\.google\.com|drive\.googleusercontent\.com/i.test(value)) {
